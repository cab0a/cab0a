...
機械学習評価、コンピュータビジョン、点群処理を中心に、再現可能な実験基盤と
監査可能なPythonツールを実装しています。

- **主な領域:** 機械学習評価、画像処理、3D・点群処理、データ品質確認
- **実装範囲:** CLI、公開API、pytest、GitHub Actions、技術文書
- **成果物:** CSV・JSON、row-level predictions、評価図、checksum、監査レポート
