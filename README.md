...
- Current release: [`v0.7.0`](https://github.com/cab0a/data-cleaning-toolkit/releases/tag/v0.7.0)
...
- Ranks unmatched mapping-source values by frequency with deterministic ordering, bounded output, and explicit privacy limitations
...
- Includes controlled type, value-mapping, mapping-coverage, unmatched-frequency, cross-column, and conditional-presence evaluations, deterministic reference outputs, 76 tests, and CI for Python 3.10 through 3.14
